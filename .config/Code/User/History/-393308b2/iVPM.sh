...
sudo nala install feh lxappearance numlockx pulseaudio-utils pavucontrol arc-theme papirus-icon-theme gpaste -y     # Puede ser un reemplazo de gpaste parcellite
