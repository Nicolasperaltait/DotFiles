...
sudo nala install xorg i3 i3lock i3status i3lock-fancy rofi lxpolkit ntfs-3g dunst suckless-tools linux-headers-amd64 -y # Esenciales para i3

sudo nala install wget curl ufw font-manager zsh htop preload kitty lxappearance  xrandr -y &&                           # Instala Paquetes basicos.

sudo nala install feh lxappearance compton numlockx pulseaudio-utils pavucontrol arc-theme papirus-icon-theme blueman -y  # sacado de https://geekland.eu/instalar-configurar-y-usar-el-gestor-de-ventanas-i3-en-linux/
