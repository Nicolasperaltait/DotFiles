...
sudo nala install feh lxappearance compton numlockx pulseaudio-utils pavucontrol arc-theme papirus-icon-theme -y     # sacado de https://geekland.eu/instalar-configurar-y-usar-el-gestor-de-ventanas-i3-en-linux/
