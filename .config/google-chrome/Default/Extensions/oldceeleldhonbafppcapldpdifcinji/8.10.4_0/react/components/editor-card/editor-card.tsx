import React, { useState, useEffect, useRef, useCallback, useMemo, forwardRef, ReactNode } from "react";
...
export type Props = CardBaseProps &
	Omit<FooterProps, "mode" | "userCanNavigate" | "isIdle"> & {
		...
		customEditorCard?: (initialContentProps: InitialContentProps) => ReactNode;
